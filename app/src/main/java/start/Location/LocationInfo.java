 ...
 */
public class LocationInfo extends Fragment implements TabLayout.OnTabSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LocationPager adapter = new LocationPager(getChildFragmentManager(), tabLayout.getTabCount());
